...
/* 20200505 sergio vado espinoza: se agrega código para evitar cancelación al insertar dato en la tabla id_numeración */
...
/*********************************/
DECLARE @max_eve_id INT = (SELECT COALESCE(MAX(eve_id),0) FROM wf_eventos)        --20200505
...
UPDATE id_numeracion SET idn_ultimo_id = COALESCE(@max_eve_id,1) WHERE idn_tabla = 'wf_eventos'  --20200505
/***********  FIN  ****************/
/*20200420 sergio vado espinoza  */
/*********************************/
