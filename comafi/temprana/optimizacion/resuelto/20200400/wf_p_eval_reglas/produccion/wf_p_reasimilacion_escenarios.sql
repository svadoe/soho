...
AS
/*
20200420 sergio vado espinoza: optimización de proceso de reasimilación
...
/*20200416 sergio vado espinoza - optimizacion utilizando operaciones de conjunto*/
  ...
  BEGIN TRY
    BEGIN TRANSACTION
      ...
      --actualiza id_numeracion
      SELECT @max_cob_id = MAX(cob_id) FROM wf_cmb_objetos
      UPDATE id_numeracion SET idn_ultimo_id = @max_cob_id WHERE idn_tabla = 'wf_cmb_objetos'
