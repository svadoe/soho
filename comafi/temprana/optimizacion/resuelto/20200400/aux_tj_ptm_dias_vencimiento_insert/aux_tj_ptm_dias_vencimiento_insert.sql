...
AS  
  -- 20200428 sergio vado espinoza se agrega: se optimiza la carga de datos de prestamos. 
  ...
  --[ INICIO 20200424 sergio vado espinoza  
  IF OBJECT_ID('tempdb..#ultima_cuota') IS NOT NULL
      DROP TABLE #ultima_cuota
  ;
  WITH cte AS (
    SELECT
      cta_per
  ...
  -- FIN 20200424 sergio vado espinoza  ]
